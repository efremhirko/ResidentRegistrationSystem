...
include('includes/config.php');
 $query = mysqli_query($con, "SELECT gender, count(*) as total FROM registerresident GROUP BY gender");
...
?>
    <div class="container">
        <div class="percent">
            <span><?php echo htmlentities($row['total']);?></span>
            <span>40%</span>
			<span>32%</span>
            <span>28%</span>
            <span><?php echo htmlentities($row['gender']);?></span>
<span><?php echo htmlentities($row['total']);?></span>
        </div>
        <div class="options">
