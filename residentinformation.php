...
<a class="dropdown-item" href='residentinfo/viewdetals1.php?id=<?php echo htmlentities($rw['id']);?>'><i class="dw dw-eye"></i>View</a>     <a class="dropdown-item" href='card/back1.php?id=<?php echo htmlentities($rw['id']);?>'><i class="dw dw-eye"></i> ID Card Front</a> 
