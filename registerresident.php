...
// Example usage: generate a 10-character random string
...
function generate_random_text($length) {
  ...
  for ($i = 0; $i < $length; $i++) {
    $password .= $characters[mt_rand(0, $max_index)];
  }
  return $password;
}

// Generate a random password
$password =md5(generate_random_text(8));
...
// Generate a random username
	...
	$house_number="L/M/".mysqli_real_escape_string($con,$_POST['house_number']);
	$zone="L/M/".mysqli_real_escape_string($con,$_POST['zone']);
...
if($rs == "")
{
$ret=mysqli_query($con,"INSERT INTO registerresident (full_name,birth_date,age,Blood_Group,mother_name,house_number,email,username,password,ecp,regstration_no,id_no,idbarcode,phone,address_of_resident,ephone,marital_status,kebele,image,gender,woreda,birthplace,zone, date_of_registration) VALUES ('$full_name','$birth_date','$age','$Blood_Group','$mother_name','$house_number','$email','$username','$password','$ecp','$regstration_no','$id_no','$barimage','$phone','$address_of_resident','$ephone','$marital_status','$kebele','$newfilename','$gender','$woreda','$birthplace','zone','$today')");
} 


$generator = new Picqer\Barcode\BarcodeGeneratorPNG();
file_put_contents($barcode, $generator->getBarcode($id_no, $generator::TYPE_CODE_39, 2, 50, $color));
      ...
      <select id="city" class="form-control" name="city" required >
        <option value="" disabled style="display:none;">Select a city</option>
						...
						<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label>Email</label>
									<input type="email" class="form-control" id="email" name="email"pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[com]{3}$" value="" placeholder="Email"  autocomplete="off"required >
								</div>                                                           
							</div>
						<div class="col-md-4 col-sm-12">
								<div class="form-group">
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									...
									<input type="date" class="form-control" id="birth_date" name="dob" max="<?php echo htmlentities(date("Y-m-d"));?>" value="" placeholder="Birth Date"  required>							</div>
							</div>
						...
						<div class="form-group">
						 ...
						 <div class="col-md-4 col-sm-12">
								<div class="form-group">
									...
									<input type="number" class="form-control" min="4" maximum="4" id="house_number" name="house_number" value="" required placeholder="House Number"  autocomplete="off">
								</div>
							</div>
				...
				<input type="text" name="ecp"  class="form-control" pattern="^[A-Z][a-z]{1,}\s[A-Z][a-z]{1,}(\s[A-Z][a-z]{1,})?$" id="full_name"  value="" placeholder="Emeregcy Contact Person" minlength="6" maxlength="50" autocomplete="off" required>
								</div>
							</div>
				</div> 
...
<input type="text"  class="form-control"  id="woreda" name="woreda" value="" placeholder="Woreda" autocomplete="off"  required>
...
<input class="form-control" type="text" id="birthplace" name="birthplace"  autocomplete="off"placeholder="Birthplace" required>
								</div>
							</div>
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
			<label for="birthplace">Zone:</label>
<input class="form-control" type="text" id="zone" name="zone" placeholder="Zone"  autocomplete="off"required>
								</div>
							</div>
...
const citiesByRegion = {
  ...
  Benishangul: [
    ...
    { value: 'Kamarashi', label: 'Kamarashi' },
