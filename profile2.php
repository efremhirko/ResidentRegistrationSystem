...
if(isset($_SESSION['ausername'])){
	 ...
	 $deliveryFee=(($data['rent'])*5)/100;
	  ...
	  $phoneLessor=$data['phone'];
	   $photoLessor=$row['photo'];
	   $emailLessor=$row['email'];
					...
					<div style="margin-top:60px"class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
						...
						<div class="pd-30 card-box height-150-p">
							<div class="profile-photo">
								...
								<img id="image" style="border-radius:50%;width:100%;height:100%" src="NewsPhoto/<?php if($row['photo']==""){echo "noimage.png";}else{echo $row['photo'];} ?>" alt="profile picture">
								 <br>
...
?>			
				...
				<div style="margin-left:20px;"class="card-box mb-20">
					...
					<div class="pd-2">
						<h4 class="text-blue h4">Rental Home Detail</h4>
					</div>
					<div class="pb-20">
...
?>	
				...
				<div style="margin-left:20px;"class="card-box mb-20">
					...
					<div class="pd-2">
						<h4 class="text-blue h4">Booked Home Detail</h4>
					</div>
					<div class="pb-20">
						<table class="table hover multiple-select-row data-table-export nowrap">
...
?>	
								...
								<td><?php echo htmlentities($row['house_id']);?></td>
									...
									<p><a href="success.php?aid=<?php echo $row['house_id']; ?>"></a>
                                   <a id="yenepayLogo" href="https://yenepay.com/checkout/Home/Process/?ItemName=<?php echo $row['category'];?>&ItemId=<?php echo $row['house_id'];?>&UnitPrice=<?php echo ($row['price']*97.5)/100;?>&Quantity=1&Process=Express&ExpiresAfter=&DeliveryFee=<?php echo ($row['price']*5)/100;?>&HandlingFee=&Tax1=&Tax2=&Discount=&SuccessUrl=http%3A%2F%2Flocalhost%2Fhouse-rent%2Fsuccess.php&IPNUrl=http%3A%2F%2Flocalhost%2Fhouse-rent%2Ferror.php&MerchantId=21136">
